<template>
    <div class="bg-white border-gray-400 border-b-gray-300 border p-1 select-none pb-2 pl-2 pr-1">
        <div class="title">
            <div :class="['text-sm', isWindowFocused ? 'text-black' : 'text-gray-400']">
                {{ appName }}
            </div>
            <div
                style="position: fixed; right: 0px; top: 0px; padding-left: 4px; padding-right: 4px"
                class="close hover:bg-[#e81123] cursor-pointer"
                @click="close"
            >
    ...
    <div
        class="bg-gray-100 border-gray-400 border-l border-r border-b pl-2 pr-2 pt-2 pb-2 text-right"
    >
        <button
            @click="close"
